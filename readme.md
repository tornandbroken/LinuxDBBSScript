...
**Instruction manual ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: :::::: ::::: :::: ::: :: :**
<p>
Click on the DualbootBluetooth.py file of that GitHub page and click again on that "<> Code" button</br>
It's also possible to download that archive in the traditional way, so you have to open your terminal and enter <code>cd ~/Downloads && git clone https://github.com/tornandbroken/LinuxDBBSScript.git</code>
